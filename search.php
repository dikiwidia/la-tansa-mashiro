			...
			<div class="features">
				<div class="col-md-12 col-sm-12 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
					<div class="feature-wrap">
						...
						<h2><?php printf( __( 'Hasil untuk pencarian: %s', 'shape' ), '<span>"' . get_search_query() . '"</span>' ); ?></h2>
						<?php
						$search_count = 0;
						...
						endwhile; endif;						
						?>
						<h3 class="lead">Ditemukan sebanyak <strong><?php echo $search_count; ?> hasil</strong> dari pencarian <strong>"<?php echo get_search_query(); ?>"</strong></h3>
					</div>
				</div><!--/.col-md-12-->
			</div><!--/.services-->
		</div><!--/.row-->    
